...
const LI_PATHS = {
  ...
  'gear':            '<circle cx="12" cy="12" r="3"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m12.72 12.72l1.42 1.42M2 12h2m16 0h2M4.93 19.07l1.41-1.41m12.72-12.72l1.42 1.42"/>',
  ...
  'brain':           '<path d="M12 4c-2 0-3.5 1.5-4 3.5-.5 0-1 .2-1.5.5C5.5 8.5 5 9.5 5 10.5c0 1 .3 1.8 1 2.5-.5.7-.8 1.5-.8 2.3 0 2 1.3 3.7 3 4.3V20c0 1.7 1.3 3 3 3s3-1.3 3-3v-.4c1.7-.6 3-2.3 3-4.3 0-.8-.3-1.6-.8-2.3.7-.7 1-1.5 1-2.5 0-1-.5-2-1.5-2.5-.5-.3-1-.5-1.5-.5-.5-2-2-3.5-4-3.5z"/><path d="M8 10h8"/><path d="M8 13h8"/><path d="M8 16h8"/>',
