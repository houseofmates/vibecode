...
mkdir -p "vibe-code-desktop.AppDir"
cp -r ../appimage_deb/data/usr "vibe-code-desktop.AppDir"

cd "vibe-code-desktop.AppDir"
mkdir -p "usr/bin"
mkdir -p "usr/lib"
...
( cd "/home/house/.cache/tauri" && ( wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/continuous/AppRun-${ARCH} || wget -q -4 -N https://github.com/AppImage/AppImageKit/releases/download/12/AppRun-${ARCH} ) )
chmod +x "/home/house/.cache/tauri/AppRun-${ARCH}"

# We need AppRun to be installed as vibe-code-desktop.AppDir/AppRun.
# Otherwise the linuxdeploy scripts will default to symlinking our main bin instead and will crash on trying to launch.
cp "/home/house/.cache/tauri/AppRun-${ARCH}" AppRun

cp "usr/share/icons/hicolor/500x500@2/apps/vibe-code-desktop.png" .DirIcon
ln -sf "usr/share/icons/hicolor/500x500@2/apps/vibe-code-desktop.png" "vibe-code-desktop.png"

ln -sf "usr/share/applications/vibe-code-desktop.desktop" "vibe-code-desktop.desktop"
...
( cd "/home/house/.cache/tauri" && wget -q -4 -N https://raw.githubusercontent.com/tauri-apps/linuxdeploy-plugin-gtk/master/linuxdeploy-plugin-gtk.sh )
( cd "/home/house/.cache/tauri" && wget -q -4 -N https://github.com/tauri-apps/binary-releases/releases/download/linuxdeploy/linuxdeploy-${linuxdeploy_arch}.AppImage )

chmod +x "/home/house/.cache/tauri/linuxdeploy-plugin-gtk.sh"
chmod +x "/home/house/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

dd if=/dev/zero bs=1 count=3 seek=8 conv=notrunc of="/home/house/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage"

OUTPUT="vibe-code-desktop_1.0.0_amd64.AppImage" "/home/house/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage" --appimage-extract-and-run --appdir "vibe-code-desktop.AppDir" --plugin gtk ${gst_plugin} --output appimage
