...
PORT = int(os.getenv("HERMES_WEBUI_PORT", "8786"))
...
REMOTE_SESSIONS_CACHE_FILE = STATE_DIR / "remote_sessions_cache.json"
...
_SETTINGS_DEFAULTS = {
    ...
    "bubble_layout": True,  # right-aligned user / left-aligned assistant chat bubbles
